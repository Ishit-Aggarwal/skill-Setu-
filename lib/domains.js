...
/** The tiles on the landing page's sector strip — balanced cross-section of all industries with AYUSH vertical. */
export const LANDING_SECTORS = [
  ...
  { abbr: "AY", full: "Ayurveda & Traditional Systems", ayush: true },
...
export const DEPARTMENT_CORE_SKILL = {
  "Ayurveda (BAMS)": "Research & Documentation",
  Panchakarma: "Problem Solving & Critical Thinking",
  "Dravyaguna (Ayurvedic Pharmacology)": "Research & Documentation",
  "Rasashastra & Bhaishajya Kalpana": "Research & Documentation",
  "Kayachikitsa (Internal Medicine)": "Problem Solving & Critical Thinking",
  "Yoga & Naturopathy (BNYS)": "Problem Solving & Critical Thinking",
  "Homeopathy (BHMS)": "Problem Solving & Critical Thinking",
  "Unani Medicine (BUMS)": "Research & Documentation",
  "Siddha Medicine (BSMS)": "Research & Documentation",
  "Ayush Pharmacy (B.Pharm Ayurveda)": "Data Analysis & Interpretation",
