 ...
 *
 * Skill Setu is a general academia–industry portal serving every field equally:
 * engineering, computer science, business, finance, design, core sciences,
 * humanities and healthcare. SIH26044 was issued by the Ministry of Ayush, so
 * the AYUSH ecosystem is modelled properly rather than being flattened into
 * "healthcare" — but it is one vertical among many, never the platform default
 * and never listed ahead of the others. Any list here that puts one sector
 * first for reasons other than alphabetical or cluster order is a bug.
 */
