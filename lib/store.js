...
const SEED_VERSION_KEY = "seededV3";
const DEMO_VERSION_KEY = "demoSeededV6";
...
const SEED_INTERNSHIPS = [
  { seedId: "seed-int-software", title: "Panchakarma Therapist Intern", company: "Kerala Ayurveda Ltd.", location: "Kochi", type: "Onsite", domain: "Panchakarma & Therapy Centres", duration: "6 months", stipendAmount: 18000, stipendMode: "monthly", tags: ["Panchakarma", "Abhyanga & Shirodhara", "Patient Counselling"], deadline: "2026-10-18", description: "Assist senior therapists through full Panchakarma cycles — Purvakarma, Pradhana karma and Paschat karma — at a NABH-accredited Ayurveda hospital.", minSkillScore: 55, eligibleDepartments: ["Ayurveda (BAMS)", "Panchakarma (PG Diploma)", "Panchakarma Therapy Assistant (Diploma)"], color: "#3C7C6B", hot: true },
  { seedId: "seed-int-data", title: "Ayurvedic Physician / Clinical Consultant Intern", company: "Arya Vaidya Sala, Kottakkal", location: "Kottakkal", type: "Onsite", domain: "Ayurveda", duration: "6 months", stipendAmount: 22000, stipendMode: "monthly", tags: ["Nadi Pariksha", "Prakriti Assessment", "Clinical Documentation"], deadline: "2026-10-25", description: "Rotate through Kayachikitsa and Panchakarma OPDs under senior vaidyas, maintaining case records to NAMASTE terminology standards.", minSkillScore: 60, eligibleDepartments: ["Ayurveda (BAMS)", "Ayurveda Postgraduate (MD/MS Ayu)"], color: "#3C8A6B", hot: true },
  { seedId: "seed-int-network", title: "GMP Compliance & Quality Control Intern (ASU&H Drugs)", company: "Dabur India Ltd.", location: "Sahibabad, Ghaziabad", type: "Onsite", domain: "ASU&H Drug Manufacturing & GMP", duration: "6 months", stipendAmount: 150000, stipendMode: "total", tags: ["GMP Compliance", "HPTLC", "Heavy Metal Testing"], deadline: "2026-11-08", description: "Support Schedule T GMP audits, batch-record review and in-process QC on classical and proprietary Ayurvedic production lines.", minSkillScore: 58, eligibleDepartments: ["Ayurvedic Pharmacy (B.Pharm Ayu)", "Rasashastra & Bhaishajya Kalpana", "Dravyaguna & Pharmacognosy"], color: "#3C5A8A", hot: false },
  { seedId: "seed-int-mech", title: "Herbal Formulation & Nutraceutical R&D Intern", company: "Himalaya Wellness Company", location: "Bengaluru", type: "Onsite", domain: "Herbal Formulation & Nutraceutical R&D", duration: "5 months", stipendAmount: 24000, stipendMode: "monthly", tags: ["Formulation", "Pharmacognosy", "Research Methodology"], deadline: "2026-11-05", description: "Work on pre-formulation studies, standardised-extract characterisation and stability protocols for new herbal SKUs.", minSkillScore: 58, eligibleDepartments: ["Ayurvedic Pharmacy (B.Pharm Ayu)", "Dravyaguna & Pharmacognosy", "Rasashastra & Bhaishajya Kalpana"], color: "#4A6B3C", hot: true },
  ...
  { seedId: "seed-int-energy", title: "Certified Yoga Instructor / Yoga Therapist Intern", company: "Central Council for Research in Yoga & Naturopathy (CCRYN)", location: "New Delhi", type: "Hybrid", domain: "Yoga & Naturopathy", duration: "4 months", stipendAmount: 15000, stipendMode: "monthly", tags: ["Yoga Therapy", "Yoga Certification Board", "Patient Counselling"], deadline: "2026-11-19", description: "Deliver supervised yoga-therapy protocols for lifestyle-disorder cohorts and record outcome measures for an ongoing CCRYN study.", minSkillScore: 52, eligibleDepartments: ["Naturopathy & Yogic Sciences (BNYS)", "Yoga Therapy (PG Diploma)", "Swasthavritta & Yoga (Preventive Health)"], color: "#6B7C3C", hot: false },
  { seedId: "seed-int-finance", title: "Regulatory Affairs Associate Intern – AYUSH Drug Licensing", company: "Charak Pharma", location: "Mumbai", type: "Hybrid", domain: "Regulatory Affairs & AYUSH Drug Licensing", duration: "3 months", stipendAmount: 20000, stipendMode: "monthly", tags: ["Regulatory Affairs", "Export Documentation", "AYUSH Premium Mark"], deadline: "2026-11-12", description: "Prepare state licensing dossiers under the Drugs & Cosmetics Act for ASU products and support AYUSH Premium Mark applications.", minSkillScore: 58, eligibleDepartments: ["Ayurvedic Pharmacy (B.Pharm Ayu)", "AYUSH Hospital Management & Public Health", "Rasashastra & Bhaishajya Kalpana"], color: "#3C4A8A", hot: false },
  { seedId: "seed-int-legal", title: "Unani Hakim (Clinical Intern)", company: "Hamdard Laboratories (India)", location: "New Delhi", type: "Onsite", domain: "Unani", duration: "3 months", stipendAmount: 45000, stipendMode: "total", tags: ["Regimenal Therapy", "Hijama", "Clinical Documentation"], deadline: "2026-11-26", description: "Clinical posting in Moalajat and Ilaj-bit-Tadbeer OPDs at a Unani teaching hospital, with case-record maintenance.", minSkillScore: 55, eligibleDepartments: ["Unani (BUMS)"], color: "#3C6B8A", hot: false },
  { seedId: "seed-int-marketing", title: "AYUSH Export/Trade Documentation Associate Intern", company: "Sri Sri Tattva", location: "Remote", type: "Remote", domain: "AYUSH Export & Trade", duration: "3 months", stipendAmount: 18000, stipendMode: "monthly", tags: ["Export Documentation", "Regulatory Affairs", "Communication"], deadline: "2026-11-28", description: "Prepare export documentation, certificates of analysis and country-specific registration files for herbal products shipped to 30+ markets.", minSkillScore: 50, eligibleDepartments: [], color: "#8A5A3C", hot: false },
  ...
  { seedId: "seed-int-design", title: "Naturopathy Consultant Intern", company: "Jindal Naturecure Institute", location: "Bengaluru", type: "Onsite", domain: "Yoga & Naturopathy", duration: "4 months", stipendAmount: 20000, stipendMode: "monthly", tags: ["Hydrotherapy", "Diet & Nutrition", "Yoga Therapy"], deadline: "2026-11-22", description: "Plan naturopathic diet, fasting and hydrotherapy regimens for in-patients under a senior naturopathy physician.", minSkillScore: 55, eligibleDepartments: ["Naturopathy & Yogic Sciences (BNYS)", "Swasthavritta & Yoga (Preventive Health)"], color: "#6B7C3C", hot: true },
  { seedId: "seed-int-editorial", title: "Pharmacopoeia Editorial & Standards Intern", company: "Pharmacopoeia Commission for Indian Medicine & Homoeopathy (PCIM&H)", location: "Ghaziabad", type: "Hybrid", domain: "AYUSH R&D & Standardisation", duration: "3 months", stipendAmount: 17000, stipendMode: "monthly", tags: ["Research Methodology", "Sanskrit", "Writing"], deadline: "2026-12-09", description: "Assist in drafting and proof-reading API/UPI monograph text and translating classical references for pharmacopoeial standards.", minSkillScore: 50, eligibleDepartments: ["Ayurveda Postgraduate (MD/MS Ayu)", "Dravyaguna & Pharmacognosy", "Ayurveda (BAMS)"], color: "#194B63", hot: false },
  ...
  { seedId: "seed-int-informatics", title: "Health-Tech Developer Intern – AYUSH Telemedicine Platform", company: "Jiva Ayurveda", location: "Remote", type: "Remote", domain: "AYUSH Telemedicine & Health-Tech", duration: "3 months", stipendAmount: 25000, stipendMode: "monthly", tags: ["Teleconsultation", "Digital Health Records", "NAMASTE"], deadline: "2026-12-15", description: "Build features for an eSanjeevani-AYUSH-style teleconsultation platform: ABDM-linked records, NAMASTE-coded diagnoses and follow-up reminders.", minSkillScore: 60, eligibleDepartments: [], color: "#3C5A8A", hot: false },
...
export function ensureSeeded() {
  ...
  ["seeded", "seededV2"].forEach((key) => window.localStorage.removeItem(nsKey(key)));
}
