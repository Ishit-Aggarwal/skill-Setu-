...
const DOMAIN_TO_SKILL = {
  ...
  // AYUSH — mapped onto the two dedicated AYUSH skill domains, not a generic
  // bucket. This is the sector the problem statement was issued for; it must
  // stay distinguishable from Biotech/Pharma/generic Research in matching.
  Ayurveda: "Ayurveda & Panchakarma",
  "Panchakarma & Wellness Therapy": "Ayurveda & Panchakarma",
  "Ayush Pharmaceuticals & Nutraceuticals": "Ayurveda & Panchakarma",
  "Ayush Diagnostics & Lab Sciences": "Ayurveda & Panchakarma",
  "Yoga & Naturopathy": "Yoga, Unani, Siddha & Homeopathy",
  "Unani Medicine": "Yoga, Unani, Siddha & Homeopathy",
  "Siddha Medicine": "Yoga, Unani, Siddha & Homeopathy",
  Homeopathy: "Yoga, Unani, Siddha & Homeopathy",
...
const TAG_TO_SKILL = [
  // AYUSH-specific tags are checked before the generic catch-alls below (order
  // matters — .find() takes the first match), so a Dravyaguna or Panchakarma
  // posting isn't absorbed into generic "Research & Documentation".
  [/panchakarma|dravyaguna|rasashastra|ayurved|dosha|vamana|virechana|\bbasti\b|snehana|swedana|kayachikitsa/i, "Ayurveda & Panchakarma"],
  [/\byoga\b|pranayama|asana|naturopath|unani|siddha|homeopath|materia medica|repertor/i, "Yoga, Unani, Siddha & Homeopathy"],
