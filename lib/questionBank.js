 ...
 * employability/campus-placement competencies screened across technology,
 * engineering, consulting, management, design and health sciences, plus two
 * AYUSH-specific domains. The AYUSH pair is NOT an opt-in elective — SIH26044
 * was commissioned by the Ministry of Ayush, so an Ayurveda, Yoga, Unani,
 * Siddha or Homeopathy student's skill profile, and any posting in those
 * sectors, must be assessed on Ayush-specific content rather than folded into
 * a generic "Research & Documentation" bucket that can't tell a BAMS student
 * from a biotech student. Ten is also the practical ceiling for this list —
 * the student skill radar and the institution's department × domain heatmap
 * both render one axis/column per domain, and both degrade past ten.
 */
...
/** Every domain a student is actually assessed and scored on — general and AYUSH alike. */
