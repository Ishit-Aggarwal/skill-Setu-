/**
 * Question banks powering the online skill assessments.
 *
 * Designed around the 8 universal employability and campus-placement competency
 * domains screened by modern enterprise recruiters across technology, engineering,
 * consulting, management, design, and health sciences.
 *
 * Specialized domain tracks (e.g. Traditional Health Systems) remain available
 * as elective modules without skewing the core skill radar for all students.
 */
...
export const QUESTION_BANK = {
  ...
  /* ---------- Elective / Specialized Sector Tracks ---------- */
  "Traditional Systems & Integrative Health": [
    { question: "The three primary functional principles (doshas) described in classical Ayurveda are:", options: ["Vata, Pitta, Kapha", "Rasa, Rakta, Mamsa", "Sattva, Rajas, Tamas", "Prana, Udana, Samana"], correct: 0 },
    { question: "In Patanjali's Ashtanga Yoga framework, 'Pratyahara' signifies:", options: ["Breath regulation", "Withdrawal of sensory engagement", "Ethical restraint", "Meditative absorption"], correct: 1 },
    { question: "The foundational classical text focusing on surgery and surgical instruments is:", options: ["Charaka Samhita", "Sushruta Samhita", "Ashtanga Hridaya", "Madhava Nidana"], correct: 1 },
    { question: "Which traditional health discipline operates on the principle of 'Similia similibus curentur'?", options: ["Homeopathy", "Ayurveda", "Unani", "Siddha"], correct: 0 },
    { question: "Standardization of herbal and botanical raw materials requires measuring:", options: ["Foreign matter, loss on drying, and total ash value", "Taste only", "Color only", "Packaging weight only"], correct: 0 },
  ],
};
...
export const SKILL_DOMAINS = CORE_SKILL_DOMAINS;

export const ELECTIVE_SKILL_DOMAINS = [
  "Traditional Systems & Integrative Health",
];
