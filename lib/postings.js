...
export async function syncRemotePostings() {
  ...
  remote.forEach((row) => {
    ...
    // Demo mode is a sealed sandbox: anything the demo personas ever mirrored
    // to the server stays out of the real portal, and the tour never picks up
    // postings real recruiters made.
