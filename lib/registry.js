...
export const REGISTRY = {
  ...
  companyCodes: {
    ...
    "TCS-IND-1001": { company: "Tata Consultancy Services", sector: "Information Technology & Software" },
    "INFY-IND-1002": { company: "Infosys Limited", sector: "Information Technology & Software" },
    "WIPRO-IND-1003": { company: "Wipro Limited", sector: "Information Technology & Software" },
    "HDFC-IND-1004": { company: "HDFC Bank", sector: "Banking, Finance & Insurance" },
    "ICICI-IND-1005": { company: "ICICI Bank", sector: "Banking, Finance & Insurance" },
    "TATAMTR-IND-1006": { company: "Tata Motors", sector: "Manufacturing & Core Engineering" },
    "LT-IND-1007": { company: "Larsen & Toubro", sector: "Manufacturing & Core Engineering" },
    "DRREDDY-IND-1008": { company: "Dr. Reddy's Laboratories", sector: "Pharmaceuticals & Biotechnology" },
  },
  instituteCodes: {
...
export function validateCompanyCode(code) {
  ...
  if (match) return { valid: true, data: match, code: cleaned };
  return { valid: false, message: "Invalid Company Code. Try TCS-IND-1001, ICICI-IND-1005, or MERIDIAN-IND-9912." };
}
