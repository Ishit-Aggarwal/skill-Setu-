...
export const PAGE_PATHS = {
  ...
  /* Applied and Saved used to be sub-tabs buried inside the pages above. They
     are the two things a student checks most often, so they get their own
     addresses — and, being real routes, they can be linked to and bookmarked. */
  "applied-internships": "/applications/internships",
  "saved-internships": "/saved/internships",
  "applied-mentorships": "/applications/mentorships",
  "saved-mentorships": "/saved/mentorships",
  ...
  settings: "/settings",
  // Reusable certificate branding for every host role (Section 4.1).
  "certificate-settings": "/certificate-settings",
  // Spaces professors and institutions run for students.
  communities: "/communities",
  "resume-coach": "/resume-coach",
  // The in-portal certificate lookup (single and bulk) for hosts.
