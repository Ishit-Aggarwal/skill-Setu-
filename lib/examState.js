...
export const AUTO_SUBMIT_REASONS = {
  ...
  window_left: "you left the test window (switching tabs or apps, minimising, or a touchpad gesture)",
  window_closed: "the test window was closed or reloaded while the paper was open",
  monitor_limit_reached: "the camera and microphone checks flagged too many violations",
};

/** Reasons that mean the attempt failed outright, whatever was answered. */
export const FAILING_REASONS = ["penalty_limit_reached", "device_lost", "window_left", "window_closed", "monitor_limit_reached"];
...
export const EVENT_LABEL = {
  ...
  FACE_MISMATCH: "A different face in front of the camera (identity check)",
  VOICE_DETECTED: "Voices heard in the room",
  WINDOW_CLOSED: "Closed or reloaded the test window",
  FACE_MONITOR_UNAVAILABLE: "Face monitoring could not start on this device",
  VOICE_MONITOR_UNAVAILABLE: "Voice monitoring could not start on this device",
