...
export const OWNER_FIELD = {
  ...
  programs: "ownerId",
  users: "id",
  // Communities are read live from the server, which keeps the same wall
  // (convex/_lib/communityCore.js#sameSide); the owner fields are listed so
  // the rule is written down in one place.
  communities: "ownerId",
  communityMembers: "userId",
  communityPosts: "authorId",
  communityComments: "authorId",
  resumeAnalyses: "studentId",
  uploads: "ownerId",
};
